    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('FUNCIONARIO', 'Funcionario'), ('CHEFE', 'Chefe do Setor'), ('ALUNO', 'Aluno'), ('PROFESSOR', 'Professor'), ('EXTERNO', 'Externo')], default='EXTERNO', max_length=20)),
